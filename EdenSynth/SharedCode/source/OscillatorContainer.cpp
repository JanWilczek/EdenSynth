...
namespace eden_vst
{
	...
	void OscillatorContainer::addOscillatorParameters(AudioProcessorValueTreeState& pluginParameters)
	{
		for (auto& oscillator : _oscillators)
		{
			...
			pluginParameters.createAndAddParameter(parameterPrefix + ".generatorName", namePrefix + " generator name", String(), NormalisableRange<float>(0.f, 4.f, 1.f), 0.f, nullptr, nullptr);
