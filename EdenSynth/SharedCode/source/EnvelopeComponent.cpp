...
void EnvelopeComponent::resized() {
  ...
  _decay1.setBounds(_attack.getX() + _attack.getWidth(), _attack.getY(),
                    _attack.getWidth(), _attack.getHeight());
  _decay2.setBounds(_decay1.getX() + _attack.getWidth(), _attack.getY(),
                    _attack.getWidth(), _attack.getHeight());
  _release.setBounds(_decay2.getX() + _attack.getWidth(), _attack.getY(),
                     _attack.getWidth(), _attack.getHeight());

  _breakLevelLabel.setBounds(_release.getX() + _attack.getWidth(),
                             _attack.getY(), _attack.getWidth(), 20);
  _breakLevel.setBounds(_release.getX() + _attack.getWidth(),
                        _breakLevelLabel.getY() + _breakLevelLabel.getHeight(),
                        _attack.getWidth(),
                        _attack.getHeight() - _breakLevelLabel.getHeight());
}
