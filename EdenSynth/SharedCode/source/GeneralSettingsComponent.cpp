...
GeneralSettingsComponent::GeneralSettingsComponent(
    ...
    : _pitchBendSemitonesUp(Slider::SliderStyle::Rotary,
      ...
      _pitchBendSemitonesDown(Slider::SliderStyle::Rotary,
                              Slider::TextEntryBoxPosition::NoTextBox),
      _a4Frequency(Slider::SliderStyle::Rotary,
                   Slider::TextEntryBoxPosition::NoTextBox) {
  _pitchBendSemitonesUpLabel.setJustificationType(
...
void GeneralSettingsComponent::resized() {
  ...
  _pitchBendSemitonesUp.setBounds(getWidth() / 2 - knobDim / 2,
                                  _pitchBendSemitonesUpLabel.getY() +
                                      _pitchBendSemitonesUpLabel.getHeight(),
                                  knobDim, knobDim);

  _pitchBendSemitonesDownLabel.setBounds(
      _pitchBendSemitonesUpLabel.getX(),
      _pitchBendSemitonesUp.getY() + _pitchBendSemitonesUp.getHeight() +
          componentSpace,
      _pitchBendSemitonesUpLabel.getWidth(), labelHeight);
  _pitchBendSemitonesDown.setBounds(
      _pitchBendSemitonesUp.getX(),
      _pitchBendSemitonesDownLabel.getY() +
          _pitchBendSemitonesDownLabel.getHeight(),
      knobDim, knobDim);

  _a4FrequencyLabel.setBounds(
      _pitchBendSemitonesUpLabel.getX(),
      _pitchBendSemitonesDown.getY() + _pitchBendSemitonesDown.getHeight() +
          componentSpace,
      _pitchBendSemitonesUpLabel.getWidth(), labelHeight);
  _a4Frequency.setBounds(
      _pitchBendSemitonesUp.getX(),
      _a4FrequencyLabel.getY() + _a4FrequencyLabel.getHeight(), knobDim,
      knobDim);
}
