...
FilterEnvelopeSegmentComponent::FilterEnvelopeSegmentComponent(AudioProcessorValueTreeState& valueTreeState, String labelContent, String parameterID)
	...
	, _slider(Slider::SliderStyle::Rotary, Slider::TextEntryBoxPosition::NoTextBox)
{
	...
	_attachment = std::make_unique<SliderAttachment>(valueTreeState, parameterID, _slider);
}
...
void FilterEnvelopeSegmentComponent::resized()
{
	...
	_slider.setBounds(getWidth() / 2 - knobDim / 2, labelHeight, knobDim, knobDim);
}
