...
FilterEnvelopeComponent::FilterEnvelopeComponent(AudioProcessorValueTreeState& valueTreeState)
...
void FilterEnvelopeComponent::resized()
{
	...
	_sustain.setBounds(_decay.getX() + segmentWidth, 0, segmentWidth, getHeight());
	_release.setBounds(_sustain.getX() + segmentWidth, 0, segmentWidth, getHeight());
}
