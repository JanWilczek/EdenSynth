...
OscillatorsComponent::OscillatorsComponent(
    ...
    : _oscillator1("osc1", std::get<0>(parameters), pathProvider),
      _oscillator2("osc2", std::get<1>(parameters), pathProvider),
      _oscillator3("osc3", std::get<2>(parameters), pathProvider) {
...
void OscillatorsComponent::resized() {
  ...
  _oscillator2.setBounds(_oscillator1.getX(),
                         _oscillator1.getY() + _oscillator1.getHeight(),
                         _oscillator1.getWidth(), _oscillator1.getHeight());
  _oscillator3.setBounds(_oscillator1.getX(),
                         _oscillator2.getY() + _oscillator2.getHeight(),
                         _oscillator1.getWidth(), _oscillator1.getHeight());
}
