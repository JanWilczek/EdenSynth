...
private:
	Label _pitchBendSemitonesUpLabel{ "pitchBendSemitonesUpLabel", "Pitch bend up" };
	Slider _pitchBendSemitonesUp;
	std::unique_ptr<SliderAttachment> _pitchBendSemitonesUpAttachment;

	Label _pitchBendSemitonesDownLabel{ "pitchBendSemitonesDownLabel", "Pitch bend down" };
