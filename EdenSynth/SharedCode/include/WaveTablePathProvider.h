...
namespace eden_vst
{
	...
	public:
		...
		typedef std::map<std::string, std::filesystem::path>::iterator path_container_iterator;
		typedef std::map<std::string, std::filesystem::path>::const_iterator path_container_const_iterator;
