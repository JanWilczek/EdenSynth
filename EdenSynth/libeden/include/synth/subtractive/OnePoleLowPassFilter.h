...
namespace eden::synth::subtractive
{
	...
	/// "Oscillator and Filter Algorithms for Virtual Analog Synthesis" by Vesa Välimäki and Antti Huovilainen.
	/// Original concept by Huovilainen.
	/// </summary>
	...
	public:
		...
		/// <summary>
		/// Sets the cutoff frequency of the filter - point at which gain falls to -3 dB.
		/// </summary>
	...
	private:
		/// <summary>
		/// Calculates the <see cref="_g"/> coefficient based on <see cref="_cutoffFrequency"/> and <see cref="_sampleRate"/>.
		/// </summary>
		void calculateG();
