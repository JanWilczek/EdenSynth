...
/// <summary>
/// Class representing a continuous periodic signal basing on given discrete
...
class Waveform {
 public:
  ...
  /// <returns>interpolated function's value at specified <paramref
  /// name="phase"/></returns>
  float operator()(float phase) const;

  /// <param name="waveTable">discrete values to interpolate from upon the calls
  /// to <see cref="operator()"/></c></param>
  void setWaveTable(WaveTable waveTable);

  /// <param name="interpolator">interpolation method to use - linear,
  /// polynomial, spline etc.</param>
