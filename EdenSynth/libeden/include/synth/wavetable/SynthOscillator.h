...
{
	/// <summary>
	/// Class representing an actual oscillator. It contains information about pitch, transposition, volume and on/off status.
	/// </summary>
	...
	public:
		...
		/// <param name="oscillatorSource">source to base the generated sound on</param>
		void setSource(std::unique_ptr<IOscillatorSource> oscillatorSource);

		/// <summary>
		/// Sets pitch transposition in octaves in regard to the pitch set by the <c>setPitch()</c> method.
		/// </summary>
		/// <param name="octaveShift">e.g. +1 means, that the rendered sound will be one octave higher than set</param>
		void setOctaveTransposition(int octaveShift);

		/// <summary>
		/// Sets pitch transposition in semitones in regard to the pitch set by the <c>setPitch()</c> method.
		/// </summary>
		...
		/// </summary>
		/// <param name="centShift">e.g. +50 means, that the rendered sound will be one quarter of a tone higher than set</param>
