...
namespace eden::synth::wavetable
{
	...
	/// Oscillator source is a sound source which oscillator uses to generate a signal at a given pitch.
	/// </summary>
	...
	public:
		...
		/// <summary>
		/// Each oscillator source should be copyable without exposing its polymorphic type.
		/// </summary>
		/// <returns>ideal clone of the source</returns>
		virtual std::unique_ptr<IOscillatorSource> clone() = 0;

		/// <summary>
		/// Resets all phase or buffer advance information. Should be called after the particular note has ended.
		/// </summary>
