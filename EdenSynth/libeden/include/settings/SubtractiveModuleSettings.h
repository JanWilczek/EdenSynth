...
{
	/// <summary>
	/// Class responsible for updating parameters of all registered subtractive modules.
	/// </summary>
	...
	public:
		...
		/// <summary>
		/// Registers given subtractive module for parameter update. From now on all of its settings will be updated automatically.
		/// </summary>
		...
		/// </summary>
		/// <param name="parameters">parameters of the filter's envelope to set - <c>ADSRParameters</c> struct instance for example</param>
