...
namespace eden
{
	...
	public:
		...
		/// <returns>current note number if it is a message concerning a note (note on, note off etc.), -1 otherwise</returns>
		int getNoteNumber() const;

		/// <summary>
		/// Sets note number. Should be used only in messages concerning notes (note on, note off etc.).
		/// </summary>
