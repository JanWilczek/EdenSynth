...
public:
  ...
  AudioBuffer(float** dataToUse,
              int numChannelsToUse,
              unsigned numSamplesToUse);
  ...
  /// <returns>array of pointers to inner mutable data block, each element in
  /// array being a pointer to a channel</returns>
  ...
  /// <returns>array of pointers to inner immutable data block, each element in
  /// array being a pointer to a channel</returns>
  ...
  /// <summary>
  /// Fills the buffer on all channels with given <paramref name="value"/> in
  /// range [<paramref name="begin"/>, <paramref name="end"/>).
  /// </summary>
  /// <param name="value"></param>
  ...
  /// </summary>
  /// <param name="callback">function to call on each channel (array of
  /// samples)</param>
