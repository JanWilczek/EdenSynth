...
namespace eden::synth::envelope
{
	...
	void EnvelopeGenerator::apply(float* channel, int startSample, int samplesToApply)
	{
	...
	void EnvelopeGenerator::setOnEnvelopeEndedCallback(Envelope::OnEnvelopeEnded callback)
	{
		_callback = callback;
		_envelope->setOnEnvelopeEndedCallback(_callback);
	}
