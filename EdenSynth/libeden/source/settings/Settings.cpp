...
Settings::Settings()
    : _tuner(std::make_shared<Tuner>()),
      ...
      _subtractiveModuleSettings(
          std::make_unique<SubtractiveModuleSettings>(_sampleRate)),
...
void Settings::registerWaveshapingModule(
...
void Settings::setOscillatorSource(OscillatorId oscillatorId,
                                   OscillatorSourceId sourceId) {
  _generatorSettings->setOscillatorSource(oscillatorId, sourceId);
}

void Settings::setOctaveTransposition(OscillatorId oscillatorId,
                                      int octaveShift) {
  _generatorSettings->setOctaveTransposition(oscillatorId, octaveShift);
}

void Settings::setSemitoneTransposition(OscillatorId oscillatorId,
                                        int semitoneShift) {
...
void Settings::setFilterEnvelopeParameters(
...
void Settings::setWaveshapingTransferFunction(
...
void Settings::setEnvelopeParameters(
